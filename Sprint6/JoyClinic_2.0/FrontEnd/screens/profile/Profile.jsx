...
const Profile = () => {
  ...
  const { userData, events, fetchData, fetchEvents, setEvents, count, fetchCountRegister, countEvents, fetchCountEvents, fetchCountDoctores, countDoctors, countCitasPaciente, fetchCountCitasPaciente } = useContext(ProfileContext);
    ...
    <View style={[styles.container, { backgroundColor: theme.theme }, { borderColor: theme.lineColor }]}>
      <View style={[styles.header, { borderColor: theme.lineColor }]}>
        ...
        <View style={[styles.statsContainer, { borderColor: theme.lineColor }]}>
          ...
          <View style={[styles.stat, { borderColor: theme.lineColor }]}>
            <Text style={[styles.statNumber, { color: theme.color }]}>{countCitasPaciente}</Text>
            <Text style={[styles.statText, { color: theme.color }]}>Cita Médica</Text>
          </View>
        </View>
      </View>
