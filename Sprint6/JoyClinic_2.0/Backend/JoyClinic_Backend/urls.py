...
from tasks.views import profileDefault, login, profile, all_events, add_event, update, register, remove, edit_profile_with_token, contar_pacientes, contar_eventos, profileDoctor, loginDoctor, all_Appointments, add_Appointments, update_Appointment, delete_Appointment, contar_doctores, contar_citas, contar_citas_paciente, all_appointments, appointments_for_patient
...
urlpatterns = [
    ...
    re_path('numero_appointments/', contar_citas),
    re_path('numero_citas_paciente', contar_citas_paciente),
    re_path('listar_citas_all', all_appointments),
    re_path('citas_paciente', appointments_for_patient)
